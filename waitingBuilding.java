 ...
 */
public class waitingBuilding<ElevatorRider> implements MyQueue<ElevatorRider> {
     ...
     */
    public waitingBuilding(int numOfFloors, int startingFloor) {
    ...
    public String toString() {
        String output = "Here is who is waiting to enter the building: \n";
        for (int i = 0; i < floorArray.length; i++) {
            output += "In the parking lot there are " + floorArray[i].toString() + "\n";
        }
        return output;
    }
