 ...
 */
public class inHome<ElevatorRider> implements MyQueue<ElevatorRider> {
     ...
     */
    public inHome(int numOfFloors, int startingFloor) {
    ...
    public String toString() {
        String output = "Here is who is waiting to go to lobby: \n";
        for (int i = 0; i < floorArray.length; i++) {
            output += "In their homes there are " + floorArray[i].toString() + "\n";
        }
        return output;
    }
